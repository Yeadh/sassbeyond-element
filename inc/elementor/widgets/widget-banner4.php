...
// Banner Parallax
class sassbeyond_Widget_Banner4 extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Banner 4', 'sassbeyond' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'banner_3',
         [
            'label' => esc_html__( 'Banner 4', 'sassbeyond' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new sassbeyond_Widget_Banner4 );